...
from mapsvc.constants import JOBS_DIR
from mapsvc.job import Job, JobStatus, job_download_filename, normalize_job_name
from mapsvc.proc import BuildCancelled, cancel_event
from mapsvc.retention import MAX_STORED_JOBS, cleanup_work_dir, jobs_to_keep
from mapsvc.storage import (
    allocate_family_ids,
    count_by_status,
    delete_job,
    get_job,
...
class JobManager:
    ...
    def start(self) -> None:
        with self._lock:
            if self._started:
                return
            from mapsvc.storage import connect

            connect()
            self._migrate_json_jobs()
            from mapsvc.tasks import huey
    ...
    def run_job(self, job_id: str) -> None:
        ...
        try:
            from mapsvc.builder import MapBuilder
    ...
    def _enqueue(self, job_id: str) -> None:
        from mapsvc.tasks import build_map
