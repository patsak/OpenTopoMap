...
# The sea/bounds data is already on the volume by now (garminsvc-init); the app
# factory validates it and refuses to start if it is not, rather than fetching it.
